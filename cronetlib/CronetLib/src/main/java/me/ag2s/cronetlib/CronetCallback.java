...
public class CronetCallback extends UrlRequest.Callback {
    ...
    CronetCallback(Request request, Call call) {
        this(request, call, null, null);
    }

    CronetCallback(Request request, Call call, EventListener eventListener) {
        this(request, call, eventListener, null);
    }

    CronetCallback(Request request, Call call, @Nullable EventListener eventListener, @Nullable Callback responseCallback) {
    ...
    private void waitforCoonlentTimeout(){
    ...
    Response waitForDone(UrlRequest urlRequest) throws IOException {
