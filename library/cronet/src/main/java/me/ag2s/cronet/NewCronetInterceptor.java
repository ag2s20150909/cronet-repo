...
public class NewCronetInterceptor implements okhttp3.Interceptor {
    private final @NonNull CookieJar mCookieJar;
    private final @NonNull CronetEngine engine;

    public NewCronetInterceptor(@NonNull CronetEngine engine,@Nullable CookieJar cookieJar) {
        this.mCookieJar = cookieJar != null ? cookieJar : CookieJar.NO_COOKIES;
        this.engine = engine;
    }
    public NewCronetInterceptor(@NonNull CronetEngine engine) {
    ...
    public Response intercept(@NonNull Chain chain) throws IOException {
        ...
        CronetHttpURLConnection connection =CronetHelper.openConnection(engine,req.url());
