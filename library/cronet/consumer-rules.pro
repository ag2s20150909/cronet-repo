...
# Contains flags that can be safely shared with CronetClient, and thus would be
...
# This constructor is called using the reflection from CronetClient API (cronet_api.jar).
