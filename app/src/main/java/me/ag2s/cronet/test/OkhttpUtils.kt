...
object OkhttpUtils {
    ...
    fun httpPost(url: String, headers: Map<String, String> =mapOf<String, String>(), body: Map<String, String>): String {
        val client: OkHttpClient = Http.okHttpClient
        //构建Body
    ...
    fun httpPostJson(url: String, data: String, headers: HashMap<String?, String?>? = null): String {
        val client: OkHttpClient = Http.okHttpClient
